...
public class OLCBlockBean {
    ...
    public static String[] order = {"PID","Index","Receive_Count","Receive_Offset","Send_Count","Send_Offset","Receive_Codes","Send_Codes"};
    ...
    public void setAll(InterfaceFileBean oneBlock) {
        ...
        for (String globalKey : global.keySet()) {
            ...
            if (!global.containsKey("PID")) {
                int pid  = CAAData.pid.get("OLC").get("Start") + (Integer.parseInt(global.get("INDEX").getValue()) - 1) * CAAData.pid.get("OLC").get("Step");
